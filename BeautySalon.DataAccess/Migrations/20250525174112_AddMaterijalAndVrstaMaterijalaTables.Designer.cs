...
namespace BeautySalon.DataAccess.Migrations
{
    ...
    [Migration("20250525174112_AddMaterijalAndVrstaMaterijalaTables")]
    partial class AddMaterijalAndVrstaMaterijalaTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautySalon.Domain.Models.Materijal", b =>
                {
                    b.Property<int>("MaterijalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("materijal_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("MaterijalId"));
                    ...
                    b.Property<string>("JedinicaMjere")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("jedinica_mjere");

                    b.Property<int>("MinimalnaKolicina")
                        .HasColumnType("integer")
                        .HasColumnName("minimalna_kolicina");
                    ...
                    b.Property<int>("TrenutnaKolicina")
                        .HasColumnType("integer")
                        .HasColumnName("trenutna_kolicina");
                    ...
                    b.ToTable("MATERIJAL", (string)null);
                });
            ...
            modelBuilder.Entity("BeautySalon.Domain.Models.VrstaMaterijala", b =>
                {
                    b.Property<int>("VrstaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("VrstaId"));
                    ...
                    b.ToTable("VRSTA_MATERIJALA", (string)null);
                });
            ...
            modelBuilder.Entity("BeautySalon.Domain.Models.Materijal", b =>
                {
                    b.HasOne("BeautySalon.Domain.Models.VrstaMaterijala", "VrstaMaterijala")
                        .WithMany()
                        .HasForeignKey("VrstaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("VrstaMaterijala");
                });
